...
| “我买过多少杯”“帮我分析我的口味偏好”“看我的历史订单”“我买过什么” | 订单追问 | 调用 `recommend_drink.py` 获取订单上下文；只在用户追问时展开完成单数、常点商品和偏好信息 |
...
| “给我推荐一杯适合当下午茶的饮品”“下午犯困但不想喝太苦” | 饮品推荐 | 调用 `recommend_drink.py`，由 Agent 根据上下文完成推荐 |
