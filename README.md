...
`xinyi-drink` 是新一好喝的 AI 导购与活动 Skill。安装后，你的 AI 助手可以帮你领 **Skill用户大礼包**、查门店、查菜单，并结合天气和可选订单历史推荐茶饮与咖啡。

## 这个 Skill 能做什么

| 能力 | 高质量问法 | 说明 |
| --- | --- | --- |
| 领取Skill用户大礼包 | “我想领取Skill用户大礼包，需要发哪个手机号？” “我的手机号是 13*********，帮我领取新一福利” | 查询小程序绑定状态并领取礼包 |
| 分析历史数据 | “我购买过多少杯新一？我的饮品偏好是什么？” “我平时更爱咖啡、茶饮还是果茶？” “我常买哪些口味？” | 需要提供小程序绑定手机号 |
| 查询门店 | “新一有哪些门店？把地址和电话都列出来” “各门店现在有多少杯在做？大概要等多久？” | 展示门店地址、电话、设施和等待情况 |
| 查询菜单商品 | “苦尽甘来拿铁热量多少？” “新一有哪些果茶？想喝清爽不太甜的” | 查询商品、价格、热量、糖度、温度和配料 |
| 推荐饮品 | “今天北京21°C，想喝茶饮，推荐一杯” “下午犯困但不想喝太苦，有什么适合的？” “想喝低卡、不太甜的，有什么建议？” | 结合天气、商品、门店和可选订单历史推荐 |
...
```text
/xinyi-drink 我想领新一好喝的Skill用户大礼包
...
- `skill/skill.json` 已声明 `homepage`、`repository`、`source.directory=skill` 和 `install.script=install.sh`，用于让 OpenClaw/ClawHub 识别这不是 instruction-only 包
